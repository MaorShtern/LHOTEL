    ...
    return (
        <NavigationContainer independent={true}>
            <drawer.Navigator initialRouteName="Home">
                <drawer.Screen name="Home" component={CustomerHome} options={{
                ...
                <drawer.Screen name="Registration" component={Registration} options={{
                    headerTitle: ' ', headerTintColor: 'white',
                    headerStyle: {
                        backgroundColor: '#000',
                ...
                <drawer.Screen name="SaveRoom" component={SaveRoom}
                    options={{
                ...
                />
                 <drawer.Screen name="ConfirmationPage" component={ConfirmationPage}
                    options={{
                        drawerItemStyle: { display: 'none' }
                    }}
                />
